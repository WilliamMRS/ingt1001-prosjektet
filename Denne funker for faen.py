...
graph(["Europe", "Asia", "Africa", "Oceania", "Americas"])
   ...
   # max_years = list(US_filtered.index)
    #plt.plot(US_filtered) #making a graph of united States from
    #plt.xticks(np.arange(len(max_years)), rotation="vertical") #making the grph readeble
  #  plt.xlabel('Years')
